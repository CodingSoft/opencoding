...
<p align="center">
<a href="https://www.npmjs.com/package/codingsoft"><img alt="npm" src="https://img.shields.io/npm/v/codingsoft?style=flat-square" /></a>
...
```bash
# YOLO
curl -fsSL https://codingsoft.org/install | bash

# Package managers
npm i -g codingsoft@latest # or bun/pnpm/yarn
...
1. `$CODINGSOFT_INSTALL_DIR` - Custom installation directory
2. `$XDG_BIN_DIR` - XDG Base Directory Specification compliant path
3. `$HOME/bin` - Standard user binary directory (if it exists or can be created)
4. `$HOME/.codingsoft/bin` - Default fallback
...
CodingSoft includes two built-in agents you can switch between with the `Tab` key.
...
If you're interested in contributing to CodingSoft, please read our [contributing docs](./CONTRIBUTING.md) before submitting a pull request.

### Building on CodingSoft

If you are working on a project that's related to CodingSoft and is using "codingsoft" as part of its name, for example "codingsoft-dashboard" or "codingsoft-mobile", please add a note to your README to clarify that it is not built by the CodingSoft team and is not affiliated with us in any way.
