...
يوجد نوعان من الوكلاء في CodingSoft: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي CodingSoft مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي CodingSoft مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي CodingSoft مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `codingsoft.json`:
...
- عام: `~/.config/codingsoft/agents/`
- لكل مشروع: `.codingsoft/agents/`
...
إذا لم يتم تحديد temperature، يستخدم CodingSoft القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات CodingSoft العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات CodingSoft الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [CodingSoft Zen](/docs/zen)، فستستخدم `codingsoft/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `codingsoft models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/codingsoft).
:::
