---
title: خوادم LSP
description: يتكامل CodingSoft مع خوادم LSP لديك.
---

يتكامل CodingSoft مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي CodingSoft مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `CODINGSOFT_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح codingsoft ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات codingsoft.
