...
مع CodingSoft يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم CodingSoft سمتنا `codingsoft`.
...
يأتي CodingSoft مع عدة سمات مدمجة.
...
- يريدون أن يطابق CodingSoft مظهر terminal لديهم
...
يدعم CodingSoft نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/codingsoft/themes/*.json` أو `$XDG_CONFIG_HOME/codingsoft/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.codingsoft/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.codingsoft/themes/*.json`
