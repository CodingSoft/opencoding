---
title: TUI
description: استخدام واجهة المستخدم TUI في CodingSoft.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CodingSoft واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CodingSoft إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CodingSoft في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CodingSoft. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CodingSoft. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات CodingSoft.
...
استخدم `CODINGSOFT_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
