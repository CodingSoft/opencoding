---
title: Paylasim
description: codingsoft konusmalarini genel baglantilarla paylasin.
---

codingsoft'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda codingsoft:
...
codingsoft, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak codingsoft manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codingsoft.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codingsoft kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
