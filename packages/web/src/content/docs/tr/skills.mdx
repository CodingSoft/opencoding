...
Ajan becerileri, codingsoft'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
codingsoft su konumlari tarar:

- Proje konfigurasyonu: `.codingsoft/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/codingsoft/skills/<name>/SKILL.md`
...
Proje yerel yollarinda codingsoft, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.codingsoft/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/codingsoft/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.codingsoft/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
codingsoft, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`codingsoft.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`codingsoft.json` icinde):
