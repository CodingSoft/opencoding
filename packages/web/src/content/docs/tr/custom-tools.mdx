---
title: Özel Araçlar
description: LLM'un codingsoft'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. codingsoft'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.codingsoft/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/codingsoft/tools/` içine yerleştirerek.
