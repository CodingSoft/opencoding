...
`.codingsoft/commands/test.md` oluştur:
...
codingsoft işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

codingsoft [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/codingsoft/commands/`
- Proje başına: `.codingsoft/commands/`
...
codingsoft, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
