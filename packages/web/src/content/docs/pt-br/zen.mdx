---
title: Zen
description: Lista selecionada de modelos fornecidos pelo CodingSoft.
---
...
O CodingSoft Zen é uma lista de modelos testados e verificados fornecidos pela equipe do CodingSoft.

:::note
O CodingSoft Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no CodingSoft. Você faz login no CodingSoft Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o CodingSoft.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o CodingSoft.
:::
...
O CodingSoft Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O CodingSoft Zen funciona como qualquer outro provedor no CodingSoft.

1. Você faz login no **<a href={console}>CodingSoft Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona CodingSoft Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do CodingSoft usa o formato `codingsoft/<model-id>`. Por exemplo, para GPT 5.3 Codex, você usaria `codingsoft/gpt-5.3-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Pro Free está disponível no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Omni Free está disponível no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Qwen3.6 Plus Free está disponível no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no CodingSoft por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o CodingSoft também.
