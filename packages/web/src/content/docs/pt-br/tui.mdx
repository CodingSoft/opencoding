---
title: TUI
description: Usando a interface de usuário de terminal codingsoft.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O codingsoft fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar codingsoft inicia o TUI para o diretório atual.
...
Ao usar o TUI do codingsoft, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao codingsoft. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do codingsoft. _Aliases_: `/quit`, `/q`
...
Isso é separado do `codingsoft.json`, que configura o comportamento do servidor/runtime.
...
Use `CODINGSOFT_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
