...
Kreiraj `.codingsoft/commands/test.md`:
...
Možete dodati prilagođene komande kroz CodingSoft konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CodingSoft [config](/docs/config):
...
- Globalno: `~/.config/codingsoft/commands/`
- Po projektu: `.codingsoft/commands/`
...
CodingSoft uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
