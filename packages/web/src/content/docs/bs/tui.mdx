---
title: TUI
description: Korištenje korisničkog interfejsa CodingSoft terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodingSoft pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CodingSoft pokreće TUI za trenutni direktorij.
...
Kada koristite CodingSoft TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CodingSoft. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CodingSoft. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codingsoft.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `CODINGSOFT_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
