...
Create `.codingsoft/commands/test.md`:
...
You can add custom commands through the CodingSoft config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your CodingSoft [config](/docs/config):
...
- Per-project: `.codingsoft/commands/`
...
codingsoft includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
