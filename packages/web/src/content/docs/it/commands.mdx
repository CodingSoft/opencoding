...
Crea `.codingsoft/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di CodingSoft o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di CodingSoft:
...
- Globale: `~/.config/codingsoft/commands/`
- Per progetto: `.codingsoft/commands/`
...
codingsoft include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
