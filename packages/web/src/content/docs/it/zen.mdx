---
title: Zen
description: Lista curata di modelli fornita da CodingSoft.
---
...
CodingSoft Zen è un elenco di modelli testati e verificati forniti dal team di CodingSoft.

:::note
CodingSoft Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in CodingSoft. Accedi a CodingSoft Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con CodingSoft.
:::
...
CodingSoft Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

CodingSoft Zen funziona come qualsiasi altro provider in CodingSoft.

1. Accedi a **<a href={console}>CodingSoft Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona CodingSoft Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di CodingSoft
usa il formato `codingsoft/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti
`codingsoft/gpt-5.3-codex` nella tua config.
...
- MiniMax M2.5 Free è disponibile su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Pro Free è disponibile su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Omni Free è disponibile su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Qwen3.6 Plus Free è disponibile su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su CodingSoft per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato CodingSoft Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con CodingSoft.
