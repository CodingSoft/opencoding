---
title: Zen
description: Kuratierte Modellliste direkt von CodingSoft.
---
...
CodingSoft Zen ist eine Liste von getesteten und verifizierten Modellen, die vom CodingSoft-Team bereitgestellt wird.

:::note
CodingSoft Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in CodingSoft. Du meldest dich bei CodingSoft Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um CodingSoft zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit CodingSoft funktionieren.
:::
...
CodingSoft Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

CodingSoft Zen funktioniert wie jeder andere Provider in CodingSoft.

1. Du meldest dich bei **<a href={console}>CodingSoft Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst CodingSoft Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner CodingSoft-Konfiguration verwendet das Format `codingsoft/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `codingsoft/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf CodingSoft verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Pro Free ist für begrenzte Zeit auf CodingSoft verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Omni Free ist für begrenzte Zeit auf CodingSoft verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Qwen3.6 Plus Free ist für begrenzte Zeit auf CodingSoft verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf CodingSoft verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf CodingSoft verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben CodingSoft Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit CodingSoft auch jeden anderen Provider zu verwenden.
