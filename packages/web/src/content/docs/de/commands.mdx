...
Erstellen Sie `.codingsoft/commands/test.md`:

```md title=".codingsoft/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die CodingSoft-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CodingSoft [config](/docs/config):

```json title="codingsoft.jsonc" {4-12}
{
...
- Global: `~/.config/codingsoft/commands/`
- Pro Projekt: `.codingsoft/commands/`

```markdown title="~/.config/codingsoft/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".codingsoft/commands/component.md"
---
...
```md title=".codingsoft/commands/create-file.md"
---
...
```md title=".codingsoft/commands/analyze-coverage.md"
---
...
```md title=".codingsoft/commands/review-changes.md"
---
...
```md title=".codingsoft/commands/review-component.md"
---
...
CodingSoft enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
