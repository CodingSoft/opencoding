---
title: TUI
description: Arbeite mit CodingSoft in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodingSoft bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet CodingSoft die TUI im aktuellen Verzeichnis.
...
In der CodingSoft-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu CodingSoft hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet CodingSoft. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `codingsoft.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `CODINGSOFT_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
