---
title: Teilen
description: Teile CodingSoft-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CodingSoft-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CodingSoft Folgendes:
...
CodingSoft hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CodingSoft den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codingsoft.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codingsoft in deiner Organisation einsetzt.
