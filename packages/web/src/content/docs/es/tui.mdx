---
title: TUI
description: Usando la interfaz de usuario del terminal CodingSoft.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodingSoft proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CodingSoft se inicia TUI para el directorio actual.
...
Cuando utilice CodingSoft TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CodingSoft. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CodingSoft. _Alias_: `/quit`, `/q`
...
Esto es independiente de `codingsoft.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `CODINGSOFT_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
