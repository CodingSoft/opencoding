---
title: Zen
description: Lista seleccionada de modelos proporcionada por CodingSoft.
---
...
CodingSoft Zen es una lista de modelos probados y verificados proporcionada por el equipo de CodingSoft.

:::note
CodingSoft Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en CodingSoft. Inicias sesión en CodingSoft Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con CodingSoft.
:::
...
CodingSoft Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

CodingSoft Zen funciona como cualquier otro proveedor en CodingSoft.

1. Inicias sesión en **<a href={console}>CodingSoft Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas CodingSoft Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de CodingSoft
usa el formato `codingsoft/<model-id>`. Por ejemplo, para GPT 5.3 Codex, usarías
`codingsoft/gpt-5.3-codex` en tu configuración.
...
- MiniMax M2.5 Free está disponible en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo V2 Pro Free está disponible en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo V2 Omni Free está disponible en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Qwen3.6 Plus Free está disponible en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en CodingSoft por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con CodingSoft.
```
