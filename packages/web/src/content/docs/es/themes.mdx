...
Con CodingSoft puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, CodingSoft usa nuestro propio tema `codingsoft`.
...
CodingSoft viene con varios temas integrados.
...
- Quiere que CodingSoft coincida con la apariencia de su terminal
...
CodingSoft admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/codingsoft/themes/*.json` o `$XDG_CONFIG_HOME/codingsoft/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.codingsoft/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.codingsoft/themes/*.json`
