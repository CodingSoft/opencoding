---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor codingsoft.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK codingsoft JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar codingsoft mediante programación.
...
Cree una instancia de codingsoft:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `codingsoft.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de codingsoft, puede crear una instancia de cliente para conectarse a ella:
