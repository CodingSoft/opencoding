...
Crear `.codingsoft/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CodingSoft o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CodingSoft [config](/docs/config):
...
- Por proyecto: `.codingsoft/commands/`
...
codingsoft incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
