...
Utwórz `.codingsoft/commands/test.md`:
...
Możesz zdefiniować polecenia w `codingsoft.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codingsoft:
...
- Globalnie: `~/.config/codingsoft/commands/`
- Na projekt: `.codingsoft/commands/`
...
codingsoft zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
