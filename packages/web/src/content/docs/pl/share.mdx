---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące codingsoft.
---

Funkcja udostępniania codingsoft umożliwia tworzenie publicznych linków do konwersacji codingsoft, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, codingsoft:
...
codingsoft obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie codingsoft korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `codingsoft.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu codingsoft w Twojej organizacji.
