---
title: TUI
description: Brug af CodingSoft-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodingSoft giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CodingSoft starter TUI for den nuværende mappe.
...
Når du bruger CodingSoft TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CodingSoft. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CodingSoft. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codingsoft.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `CODINGSOFT_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
