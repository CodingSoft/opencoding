...
Opret `.codingsoft/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem CodingSoft-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din CodingSoft [config](/docs/config):
...
- Globalt: `~/.config/codingsoft/commands/`
- Pr. projekt: `.codingsoft/commands/`
...
codingsoft indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
