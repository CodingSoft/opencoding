...
Brug den til at bygge integrasjoner og kontrollere codingsoft programmatisk.
...
Opret en forekomst av codingsoft:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codingsoft.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codingsoft, kan du oprete en klientforekomst for at koble til den:
