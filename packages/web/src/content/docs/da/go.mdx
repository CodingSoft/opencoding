...
CodingSoft Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

:::note
CodingSoft Go er i øjeblikket i beta.
:::

Go fungerer som enhver anden udbyder i CodingSoft. Du abonnerer på CodingSoft Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med CodingSoft.
:::
...
CodingSoft Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

CodingSoft Go fungerer som enhver anden udbyder i CodingSoft.

1. Du logger ind på **<a href={console}>CodingSoft Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `CodingSoft Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på CodingSoft Go.
:::
...
CodingSoft Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din CodingSoft config
bruger formatet `codingsoft-go/<model-id>`. For eksempel for Kimi K2.5, vil du
bruge `codingsoft-go/kimi-k2.5` i din config.
...
Vi skabte CodingSoft Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med CodingSoft.
