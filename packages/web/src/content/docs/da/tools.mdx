...
Her er alle de innebygde verktøyene som er tilgængelige i CodingSoft.
...
:::note
Dette verktøyet er bare tilgængelig når `CODINGSOFT_EXPERIMENTAL_LSP_TOOL=true` (eller `CODINGSOFT_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger CodingSoft-leverandøren eller når miljøvariabelen `CODINGSOFT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
