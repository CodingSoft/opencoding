...
CodingSoft Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
CodingSoft Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i CodingSoft. Du abonnerer på CodingSoft Go og
...
CodingSoft Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

CodingSoft Go fungerer som enhver annen leverandør i CodingSoft.

1. Du logger inn på **<a href={console}>CodingSoft Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `CodingSoft Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på CodingSoft Go.
:::
...
CodingSoft Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din CodingSoft-konfigurasjon
bruker formatet `codingsoft-go/<model-id>`. For eksempel, for Kimi K2.5, vil du
bruke `codingsoft-go/kimi-k2.5` i konfigurasjonen din.
...
Vi opprettet CodingSoft Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med CodingSoft også.
