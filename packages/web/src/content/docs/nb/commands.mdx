...
Opprett `.codingsoft/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CodingSoft-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CodingSoft [config](/docs/config):
...
- Per prosjekt: `.codingsoft/commands/`
...
CodingSoft inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
