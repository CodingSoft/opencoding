---
title: TUI
description: Bruke codingsoft-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodingSoft gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CodingSoft starter TUI for gjeldende katalog.
...
Når du bruker CodingSoft TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CodingSoft. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CodingSoft. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codingsoft.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `CODINGSOFT_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
