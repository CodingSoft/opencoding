...
สร้าง `.codingsoft/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CodingSoft:
...
- ระดับผู้ใช้ (Global): `~/.config/codingsoft/commands/`
- ระดับโปรเจ็กต์: `.codingsoft/commands/`
...
CodingSoft มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
