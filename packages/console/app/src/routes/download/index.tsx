...
import desktopAppIcon from "../../asset/lander/codingsoft-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://codingsoft.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>codingsoft.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g codingsoft-ai")}>
                <code>
                  npm i -g <strong>codingsoft-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g codingsoft-ai")}>
                <code>
                  bun add -g <strong>codingsoft-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/codingsoft")}>
                <code>
                  brew install <strong>anomalyco/tap/codingsoft</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S codingsoft")}>
                <code>
                  paru -S <strong>codingsoft</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask codingsoft-desktop")}>
                <code>
                  brew install --cask <strong>codingsoft-desktop</strong>
                </code>
                <CopyStatus />
              </button>
