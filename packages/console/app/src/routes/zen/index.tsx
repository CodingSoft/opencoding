...
import compareVideo from "../../asset/lander/codingsoft-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codingsoft-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codingsoft:auth" content={loggedin() ? "true" : "false"} />
