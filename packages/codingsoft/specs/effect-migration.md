...
Practical reference for new and migrated Effect code in `packages/codingsoft`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codingsoft/Foo") {}
