...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODINGSOFT_CALLER", () => {
    process.env["CODINGSOFT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODINGSOFT_CALLER", () => {
    process.env["CODINGSOFT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODINGSOFT_CALLER", () => {
    process.env["CODINGSOFT_CALLER"] = "unknown"
