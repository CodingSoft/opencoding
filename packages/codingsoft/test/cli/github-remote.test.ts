...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codingsoft.git")).toEqual({ owner: "sst", repo: "codingsoft" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codingsoft")).toEqual({ owner: "sst", repo: "codingsoft" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codingsoft.git")).toEqual({ owner: "sst", repo: "codingsoft" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codingsoft")).toEqual({ owner: "sst", repo: "codingsoft" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codingsoft.git")).toEqual({ owner: "sst", repo: "codingsoft" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codingsoft")).toEqual({ owner: "sst", repo: "codingsoft" })
})
