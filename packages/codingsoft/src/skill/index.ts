...
export namespace Skill {
  ...
  const CODINGSOFT_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.CODINGSOFT_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, CODINGSOFT_SKILL_PATTERN)
    }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codingsoft/Skill") {}
