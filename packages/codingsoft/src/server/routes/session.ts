  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all CodingSoft sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific CodingSoft session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new CodingSoft session for interacting with AI assistants and managing conversations.",
