...
export namespace LLM {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codingsoft/LLM") {}
  ...
  export async function stream(input: StreamRequest) {
    ...
    // from the workflow service are executed via codingsoft's tool system
    ...
    return streamText({
      ...
      abortSignal: input.abort,
      headers: {
        ...(input.model.providerID.startsWith("codingsoft")
          ? {
              "x-codingsoft-project": Instance.project.id,
              "x-codingsoft-session": input.sessionID,
              "x-codingsoft-request": input.user.id,
              "x-codingsoft-client": Flag.CODINGSOFT_CLIENT,
            }
          : {
