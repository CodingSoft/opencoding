...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@codingsoft-ai/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codingsoft/ToolRegistry") {}
  ...
  export const layer: Layer.Layer<Service, never, Config.Service | Plugin.Service> = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const all = Effect.fn("ToolRegistry.all")(function* (custom: Tool.Info[]) {
        ...
        const question = ["app", "cli", "desktop"].includes(Flag.CODINGSOFT_CLIENT) || Flag.CODINGSOFT_ENABLE_QUESTION_TOOL
        ...
        return [
          ...
          SkillTool,
          ApplyPatchTool,
          ...(Flag.CODINGSOFT_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
          ...(cfg.experimental?.batch_tool === true ? [BatchTool] : []),
          ...(Flag.CODINGSOFT_EXPERIMENTAL_PLAN_MODE && Flag.CODINGSOFT_CLIENT === "cli" ? [PlanExitTool] : []),
          ...custom,
        ]
      })
      ...
      const tools = Effect.fn("ToolRegistry.tools")(function* (
        ...
        const filtered = allTools.filter((tool) => {
          if (tool.id === "codesearch" || tool.id === "websearch") {
            return model.providerID === ProviderID.codingsoft || Flag.CODINGSOFT_ENABLE_EXA
          }
