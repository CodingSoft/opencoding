...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition } from "@codingsoft-ai/plugin/tui"
...
import { createOpencodingClient, type OpencodeClient } from "@codingsoft-ai/sdk/v2"
...
export function createTuiApi(input: Input): TuiHostPluginApi {
  ...
  const scoped: TuiPluginApi["scopedClient"] = (workspaceID) => {
    ...
    const next = createOpencodingClient({
