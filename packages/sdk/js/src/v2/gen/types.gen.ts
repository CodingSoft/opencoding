...
/**
 * Server configuration for codingsoft serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: codingsoft.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://codingsoft.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://codingsoft.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
