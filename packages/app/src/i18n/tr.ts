...
export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codingsoft.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.codingsoftGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CodingSoft tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CodingSoft'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve CodingSoft'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CodingSoft'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codingsoft.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CodingSoft sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "CodingSoft'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CodingSoft ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codingsoft.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CodingSoft henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CodingSoft Masaüstü",
  ...
  "settings.desktop.wsl.description": "CodingSoft sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CodingSoft'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "CodingSoft'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CodingSoft'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CodingSoft'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CodingSoft başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CodingSoft'un en son sürümünü kullanıyorsunuz.",
