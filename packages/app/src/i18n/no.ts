...
export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codingsoft.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.codingsoftGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CodingSoft.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "Besøk ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CodingSoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CodingSoft.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codingsoft.json",
  ...
  "dialog.server.description": "Bytt hvilken CodingSoft-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CodingSoft ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CodingSoft-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codingsoft.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CodingSoft ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CodingSoft-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CodingSoft",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CodingSoft ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om CodingSoft skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CodingSoft er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CodingSoft starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CodingSoft.",
