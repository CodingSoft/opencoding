export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codingsoft.tagline": "Modelos optimizados y fiables",
  "dialog.provider.codingsoftGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CodingSoft.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.codingsoftZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.codingsoftZen.visit.prefix": "Visita ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CodingSoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CodingSoft.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codingsoft.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de CodingSoft se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de CodingSoft ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CodingSoft",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codingsoft.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CodingSoft no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CodingSoft dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CodingSoft",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve CodingSoft en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CodingSoft sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CodingSoft.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CodingSoft",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CodingSoft.",
