export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codingsoft.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codingsoftGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodingSoft.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "Odwiedź ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodingSoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodingSoft.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codingsoft.json",
  ...
  "dialog.server.description": "Przełącz serwer CodingSoft, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CodingSoft ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodingSoft",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codingsoft.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "CodingSoft zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodingSoft",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CodingSoft na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodingSoft ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodingSoft.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodingSoft",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodingSoft.",
