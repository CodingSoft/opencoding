export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codingsoft.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codingsoftGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CodingSoft-u.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "Posjeti ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CodingSoft-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CodingSoft-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codingsoft.json",
  ...
  "dialog.server.description": "Promijeni na koji se CodingSoft server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija CodingSoft-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CodingSoft timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (codingsoft.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CodingSoft još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CodingSoft server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CodingSoft-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako CodingSoft izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CodingSoft prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CodingSoft-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CodingSoft pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CodingSoft-a.",
