export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codingsoft.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codingsoftGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodingSoft.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "Visite ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodingSoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodingSoft.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codingsoft.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CodingSoft este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do CodingSoft ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CodingSoft",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codingsoft.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CodingSoft ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CodingSoft dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CodingSoft",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o CodingSoft aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CodingSoft segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CodingSoft é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodingSoft iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodingSoft.",
