export const dict = {
  ...
  "dialog.provider.codingsoft.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codingsoft.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.codingsoftGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CodingSoft",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CodingSoft.",
  ...
  "provider.connect.codingsoftZen.line1":
    "CodingSoft Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.codingsoftZen.visit.prefix": "Besøg ",
  "provider.connect.codingsoftZen.visit.link": "codingsoft.ai/zen",
  "provider.connect.codingsoftZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CodingSoft.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CodingSoft.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codingsoft.json",
  ...
  "dialog.server.description": "Skift hvilken CodingSoft-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CodingSoft ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CodingSoft-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (codingsoft.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CodingSoft understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CodingSoft inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CodingSoft-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CodingSoft",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CodingSoft ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om CodingSoft følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CodingSoft er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CodingSoft starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CodingSoft.",
