...
beforeAll(async () => {
  ...
  mock.module("@codingsoft-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codingsoft-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codingsoft-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codingsoft-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
