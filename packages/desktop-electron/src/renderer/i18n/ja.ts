export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの CodingSoft を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "CodingSoft のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'codingsoft' コマンドを使用してください。",
