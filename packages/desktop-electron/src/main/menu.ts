...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "CodingSoft Documentation", click: () => shell.openExternal("https://codingsoft.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/codingsoft") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/anomalyco/codingsoft/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/codingsoft/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
