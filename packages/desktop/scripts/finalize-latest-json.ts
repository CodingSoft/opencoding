...
const releaseId = process.env.CODINGSOFT_RELEASE
if (!releaseId) throw new Error("CODINGSOFT_RELEASE is required")

const version = process.env.CODINGSOFT_VERSION
if (!releaseId) throw new Error("CODINGSOFT_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "codingsoft-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "codingsoft-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "codingsoft-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "codingsoft-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "codingsoft-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "codingsoft-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "codingsoft-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "codingsoft-desktop-darwin-aarch64.app.tar.gz",
  },
]
