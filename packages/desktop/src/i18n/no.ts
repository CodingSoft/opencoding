export const dict = {
  ...
  "desktop.menu.help.documentation": "CodingSoft Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CodingSoft CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
