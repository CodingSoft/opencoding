export const dict = {
  ...
  "desktop.menu.help.documentation": "CodingSoft Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "CodingSoft CLI binary is missing. Try reinstalling the desktop app.",
