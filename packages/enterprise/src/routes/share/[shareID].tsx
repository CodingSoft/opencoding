import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@codingsoft-ai/sdk/v2"
import { SessionTurn } from "@codingsoft-ai/ui/session-turn"
import { SessionReview } from "@codingsoft-ai/ui/session-review"
import { DataProvider } from "@codingsoft-ai/ui/context"
import { FileComponentProvider } from "@codingsoft-ai/ui/context/file"
import { WorkerPoolProvider } from "@codingsoft-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codingsoft-ai/ui/logo"
import { IconButton } from "@codingsoft-ai/ui/icon-button"
import { ProviderIcon } from "@codingsoft-ai/ui/provider-icon"
import { iife } from "@codingsoft-ai/util/iife"
import { Binary } from "@codingsoft-ai/util/binary"
import { NamedError } from "@codingsoft-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@codingsoft-ai/ui/tabs"
import { MessageNav } from "@codingsoft-ai/ui/message-nav"
import { FileSSR } from "@codingsoft-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codingsoft-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/codingsoft-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CodingSoft</Title>
              </Show>
              <Meta name="description" content="codingsoft - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/codingsoft"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://codingsoft.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
