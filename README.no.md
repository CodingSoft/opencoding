...
brew install CodingSoft/tap/codingsoft # macOS og Linux (anbefalt, alltid oppdatert)
brew install codingsoft              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
CodingSoft er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/CodingSoft/codingsoft/releases) eller [codingsoft.vercel.app/download](https://codingsoft.vercel.app/download).
...
1. `$CODINGSOFT_INSTALL_DIR` - Egendefinert installasjonsmappe
...
CodingSoft har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://codingsoft.vercel.app/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer CodingSoft, [**se dokumentasjonen**](https://codingsoft.vercel.app/docs).

### Bidra

Hvis du vil bidra til CodingSoft, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på CodingSoft

Hvis du jobber med et prosjekt som er relatert til CodingSoft og bruker "codingsoft" som en del av navnet; for eksempel "codingsoft-dashboard" eller "codingsoft-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av CodingSoft-teamet og ikke er tilknyttet oss på noen måte.
...
- 100% open source
- Ikke knyttet til en bestemt leverandør. Selv om vi anbefaler modellene vi tilbyr gjennom [CodingSoft Zen](https://codingsoft.vercel.app/zen); kan CodingSoft brukes med Claude, OpenAI, Google eller til og med lokale modeller. Etter hvert som modellene utvikler seg vil gapene lukkes og prisene gå ned, så det er viktig å være provider-agnostic.
- LSP-støtte rett ut av boksen
- Fokus på TUI. CodingSoft er bygget av neovim-brukere og skaperne av [terminal.shop](https://terminal.shop); vi kommer til å presse grensene for hva som er mulig i terminalen.
- Klient/server-arkitektur. Dette kan for eksempel la CodingSoft kjøre på maskinen din, mens du styrer den eksternt fra en mobilapp. Det betyr at TUI-frontend'en bare er en av de mulige klientene.
